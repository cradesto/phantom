...
!
 ...
 end interface get_idealpluspoly_temp
...
subroutine get_idealpluspoly_temp_from_full_en(rhoi,eni,polyk,gamma,mu,tempi)
 ...
 character(len=*), parameter :: function_name = 'get_idealpluspoly_temp_from_full_en'
...
subroutine get_idealpluspoly_temp_from_therm_en(eni,mu,tempi)
 ...
 character(len=*), parameter :: function_name = 'get_idealpluspoly_temp_from_therm_en'
...
subroutine get_idealpluspoly_full_press_over_rho_from_full_en(rhoi,eni,polyk,gamma,ponrhoi)
 ...
 character(len=*), parameter :: function_name = 'get_idealpluspoly_full_press_over_rho_from_full_en'
...
subroutine get_idealpluspoly_full_press_over_rho_from_therm_en(rhoi,eni,polyk,gamma,ponrhoi)
 ...
 character(len=*), parameter :: function_name = 'get_idealpluspoly_full_press_over_rho_from_therm_en'
...
subroutine get_idealpluspoly_full_press_over_rho_from_temp(rhoi,polyk,gamma,mu,tempi,ponrhoi)
 ...
 character(len=*), parameter :: function_name = 'get_idealpluspoly_full_press_over_rho_from_temp'
...
subroutine get_idealpluspoly_therm_press_over_rho_from_therm_en(eni,ponrhoi)
 ...
 character(len=*), parameter :: function_name = 'get_idealpluspoly_therm_press_over_rho_from_therm_en'
...
subroutine get_idealpluspoly_spsoundi_from_full_en(rhoi,eni,polyk,gamma,spsoundi)
 ...
 character(len=*), parameter :: function_name = 'get_idealpluspoly_spsoundi_from_full_en'
...
subroutine get_idealpluspoly_spsoundi_from_therm_en(rhoi,eni,polyk,gamma,spsoundi)
 ...
 character(len=*), parameter :: function_name = 'get_idealpluspoly_spsoundi_from_therm_en'
 ...
 spsoundi = gamma*polyk*rhoi**(gamma-1.) + 10.0/9.0*eni
 spsoundi = sqrt(max(0.,spsoundi))
...
subroutine get_idealpluspoly_spsoundi_from_temp(rhoi,polyk,gamma,mu,tempi,spsoundi)
 ...
 character(len=*), parameter :: function_name = 'get_idealpluspoly_spsoundi_from_temp'
...
subroutine get_idealpluspoly_temp_from_pres(presi_cgs,rhoi_cgs,polyk,gamma,mu,tempi)
 ...
 character(len=*), parameter :: function_name = 'get_idealpluspoly_temp_from_pres'
...
subroutine get_idealpluspoly_full_en_from_temp(rhoi_cgs,polyk,gamma,mu,tempi,eni_cgs)
 ...
 character(len=*), parameter :: function_name = 'get_idealpluspoly_full_en_from_temp'
...
subroutine get_idealpluspoly_therm_en_from_temp(mu,tempi,eni_cgs)
 ...
 character(len=*), parameter :: function_name = 'get_idealpluspoly_therm_en_from_temp'
