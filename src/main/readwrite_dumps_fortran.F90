...
!
 ...
 do ipass=1,2
    do k=1,ndatatypes
       ...
       if (eos_is_non_ideal(ieos) .or. eos_outputs_temp(ieos) .and. .not.store_dust_temperature .or. icooling > 0) then
    ...
    do k=1,ndatatypes
       ...
       do i=1,nums(k,iarr)
          ...
          case(1)
             ...
             if (eos_is_non_ideal(ieos) .or. eos_outputs_temp(ieos)) then
